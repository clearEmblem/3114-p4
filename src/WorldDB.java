...
public class WorldDB implements ATC {
    ...
    public final void clear() {
        ...
        bintreeRoot = EmptyLeafNode.getInstance();
    }
    ...
    public boolean add(AirObject a) {
        ...
        // 5. Insert into Bintree (LATER)
        // bintreeRoot = bintreeRoot.insert(a, ...);
    ...
    public String delete(String name) {
        ...
        if (removed == null) {
            return null; // For testEmpty
        }
        
        // Remove from Bintree (LATER)
        // bintreeRoot = bintreeRoot.remove(removed, ...);
    ...
    public String printbintree() {
        StringBuilder sb = bintreeRoot.print(
            0, WORLD_MIN, WORLD_MIN, WORLD_MIN, WORLD_MAX);
            
        int nodes = bintreeRoot.countNodes();
    ...
    public String collisions() {
        // This is the stubbed response for testEmpty
        // You will implement this for a later milestone.
